import { BadgeCheck, EllipsisVertical, Plus, X } from 'lucide-react'
import { useState } from 'react'
import { tasks } from '../constant'
import { NavLink } from 'react-router-dom'

const MobileSidebar = ({ openMobileMenu, setOpenMobileMenu, setCreateList, setLists, lists, randomColor }) => {
    ...
    return (
        <>
            <div onClick={() => {
                setDropDown(null)
            }} className={["absolute lg:hidden flex flex-col justify-between w-60 p-3 rounded-xl h-full bg-(--Surface) transition-all duration-200 ease-out", openMobileMenu ? "translate-x-0" : "-translate-x-90"].join(" ")}>
