import { BadgeCheck, EllipsisVertical, PanelLeft, Plus, Search, Trash2 } from 'lucide-react'
...
const Sidebar = ({ setCreateList, lists, randomColor }) => {
    ...
    return (
        <div className='select-none hidden lg:flex flex-col justify-between left-3 w-60 md:w-56 p-3 rounded-xl h-full bg-(--Surface)'>
